...
public class Mahjong_S2C_TurnProto : IProto
{
    ...
    public class PokerGroup
    {
        ...
        public void Deserialize(byte[] buffer)
        {
            ...
            using (MemoryStream ms = new MemoryStream(buffer))
            {
                ...
                if(pokersBytes != null) pokers = new Poker(ms.ReadBytes());
            }
        }
    }
    ...
    public void Deserialize(byte[] buffer)
    {
        ...
        using (MemoryStream ms = new MemoryStream(buffer))
        {
            ...
            {
                byte[] askPokerGroupBytes = ms.ReadBytes();
                if(askPokerGroupBytes != null) askPokerGroupList.Add(new PokerGroup(askPokerGroupBytes));
            }
        }
    }
}
