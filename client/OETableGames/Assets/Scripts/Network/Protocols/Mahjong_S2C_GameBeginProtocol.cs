...
public class Mahjong_S2C_GameBeginProto : IProto
{
        ...
        public void Deserialize(byte[] buffer)
        {
            ...
            using (MemoryStream ms = new MemoryStream(buffer))
            {
                ...
                for (int i = 0; i < universalPokerListLength; ++i)
                {
                    ...
                    if(universalPokerBytes != null) universalPokerList.Add(new Poker(universalPokerBytes));
                }
            }
        }
    }
    ...
    public void Deserialize(byte[] buffer)
    {
        ...
        using (MemoryStream ms = new MemoryStream(buffer))
        {
            ...
            byte[] luckPokerBytes = ms.ReadBytes();
            if(luckPokerBytes != null) luckPoker = new Poker(ms.ReadBytes());
