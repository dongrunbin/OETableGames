...
public class Mahjong_S2C_RoomInfoProto : IProto
{
        ...
        public void Deserialize(byte[] buffer)
        {
            ...
            using (MemoryStream ms = new MemoryStream(buffer))
            {
                ...
                for (int i = 0; i < pokersListLength; ++i)
                {
                    ...
                    if(pokersBytes != null) pokersList.Add(new Mahjong(pokersBytes));
                }
            }
        }
    }
    ...
    public class Seat
    {
        ...
        public void Deserialize(byte[] buffer)
        {
            ...
            using (MemoryStream ms = new MemoryStream(buffer))
            {
                ...
                if(hitPokerBytes != null) hitPoker = new Mahjong(ms.ReadBytes());
                ...
                for (int i = 0; i < usedPokerGroupListLength; ++i)
                {
                    ...
                    if(usedPokerGroupBytes != null) usedPokerGroupList.Add(new MahjongGroup(usedPokerGroupBytes));
                }
    ...
    public void Deserialize(byte[] buffer)
    {
        ...
        using (MemoryStream ms = new MemoryStream(buffer))
        {
            ...
            {
                byte[] askPokerGroupsBytes = ms.ReadBytes();
                if(askPokerGroupsBytes != null) askPokerGroupsList.Add(new MahjongGroup(askPokerGroupsBytes));
            }
