        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<DrbFramework.DataTable.IDataTableParser>(L, 2))
				{
					...
					var gen_ret = new DrbFramework.DataTable.DataTableSystem(_parser);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _typeName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetDataTable( _typeName );
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Type>(L, 2)) 
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        var gen_ret = gen_to_be_invoked.GetDataTable( _type );
                        translator.PushAny(L, gen_ret);
