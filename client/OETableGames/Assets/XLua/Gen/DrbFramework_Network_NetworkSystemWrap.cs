        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new DrbFramework.Network.NetworkSystem();
		    ...
		    try {
                ...
                
                {
                    ...
                    DrbFramework.Network.INetworkDecoder _decoder = (DrbFramework.Network.INetworkDecoder)translator.GetObject(L, 5, typeof(DrbFramework.Network.INetworkDecoder));
                        ...
                        var gen_ret = gen_to_be_invoked.CreateChannel( _channelName, _handler, _encoder, _decoder );
		    ...
		    try {
                ...
                
                {
                    string _channelName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetChannel( _channelName );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _channelName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.HasChannel( _channelName );
