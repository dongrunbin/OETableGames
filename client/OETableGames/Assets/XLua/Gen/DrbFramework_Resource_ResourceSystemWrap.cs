...
namespace XLua.CSObjectWrap
{
    ...
    public class DrbFrameworkResourceResourceSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 20, 10, 4);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetAllAssetBundleName", _m_GetAllAssetBundleName);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetAllAssetName", _m_GetAllAssetName);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 5 && translator.Assignable<DrbFramework.Resource.IResourceLoader>(L, 2) && translator.Assignable<DrbFramework.Resource.IResourceHolder>(L, 3) && translator.Assignable<DrbFramework.Resource.IResourceDecoder>(L, 4) && translator.Assignable<DrbFramework.Resource.IDependencyManifest>(L, 5))
				{
					...
					DrbFramework.Resource.IDependencyManifest _dependencyManifest = (DrbFramework.Resource.IDependencyManifest)translator.GetObject(L, 5, typeof(DrbFramework.Resource.IDependencyManifest));
					
					var gen_ret = new DrbFramework.Resource.ResourceSystem(_loader, _holder, _decoder, _dependencyManifest);
		    ...
		    try {
                ...
                
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 3, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.LoadFile( _filePath, _mode );
        ...
        static int _m_LoadManifestFile(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.LoadManifestFile(  );
		    ...
		    try {
                ...
                
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 3, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.LoadAssetBundle( _assetBundlePath, _mode );
		    ...
		    try {
                ...
                
                {
                    string _assetBundlePath = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.IsLoadingAssetBundle( _assetBundlePath );
		    ...
		    try {
                ...
                
                {
                    ...
                    string _assetName = LuaAPI.lua_tostring(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.IsLoadingAsset( _assetBundlePath, _assetName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 4, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.LoadAssetFromAssetBundle( _assetBundlePath, _assetName, _mode );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 3, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.LoadAsset( _assetPath, _mode );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<DrbFramework.Resource.LoadMode>(L, 3)) 
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 3, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.HasAsset( _assetPath, _mode );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& translator.Assignable<DrbFramework.Resource.LoadMode>(L, 4)) 
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 4, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.HasAsset( _assetBundlePath, _assetName, _mode );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 3, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.HasAssetBundle( _assetBundlePath, _mode );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<DrbFramework.Resource.LoadMode>(L, 3)) 
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 3, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.ReleaseAsset( _assetPath, _mode );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& translator.Assignable<DrbFramework.Resource.LoadMode>(L, 4)) 
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 4, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.ReleaseAsset( _assetBundlePath, _assetName, _mode );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    DrbFramework.Resource.LoadMode _mode;translator.Get(L, 3, out _mode);
                        ...
                        var gen_ret = gen_to_be_invoked.ReleaseAssetBundle( _assetBundlePath, _mode );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetAllAssetBundleName(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetAllAssetBundleName(  );
                        translator.PushAny(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetAllAssetName(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetAllAssetName(  );
                        translator.PushAny(L, gen_ret);
