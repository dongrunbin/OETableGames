...
import com.zhenyi.remoting.framework.provider.ProviderFactoryBean;
...
public class ProviderFactoryBeanDefinitionParser extends AbstractSingleBeanDefinitionParser
{
	...
	protected void doParse(Element element, BeanDefinitionBuilder bean)
	{
		...
		try
		{
			...
			String paramIndex = element.getAttribute("paramIndex");
			String minParam = element.getAttribute("minParam");
			String maxParam = element.getAttribute("maxParam");
			...
			if(NumberUtils.isNumber(paramIndex))
			{
				bean.addPropertyValue("paramIndex", Integer.parseInt(paramIndex));
			}
			if(NumberUtils.isNumber(minParam))
			{
				bean.addPropertyValue("minParam", Long.parseLong(minParam));
			}
			if(NumberUtils.isNumber(maxParam))
			{
				bean.addPropertyValue("maxParam", Long.parseLong(maxParam));
			}
