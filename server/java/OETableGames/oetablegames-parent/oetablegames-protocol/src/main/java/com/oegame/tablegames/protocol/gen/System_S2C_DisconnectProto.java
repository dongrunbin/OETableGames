...
/// S2C_Disconnect
/// </summary>
public class System_S2C_DisconnectProto
{
    ...
    public static System_S2C_DisconnectProto getProto(byte[] buffer)
    {
        if(buffer == null) return null;
        System_S2C_DisconnectProto proto = new System_S2C_DisconnectProto();
        return proto;
    }
}
