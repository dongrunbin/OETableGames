package com.oegame.tablegames.common.net.http;
...
public class NetworkHttp
{
	 ...
	 * 设置默认的响应字符集
	 */
	public static void setDefaultContentEncoding(String defaultEncoding)
	{
		defaultContentEncoding = defaultEncoding;
	}
