...
public class PlayerServiceImpl implements PlayerService
{
	...
	{
		List<PlayerEntity> list = PlayerDBModel.getInstance().getList();
...
//			com.oegame.tablegames.service.ServiceUtil.getProxyService().sendMessage(playerId, s2c.toArray());
//		}
	}
...
//				Player com.oegame.tablegames.service.player = new Player(entity.id,entity.nickname,entity.avatar + "/132",entity.gender,entity.roomId,entity.online,entity.latitude,entity.longitude,entity.cards,entity.gameId);
//				this.players.put(entity.id, com.oegame.tablegames.service.player);
//				ret.add(com.oegame.tablegames.service.player);
//			}
//			return ret;
//		}
//		return null;
